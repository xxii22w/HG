...
#define HG_PROFILE 1
#if HG_PROFILE
#define HG_PROFILE_BEGIN_SESSION(name, filepath) ::hg::Instrumentor::Get().BeginSession(name, filepath)
#define HG_PROFILE_END_SESSION() ::hg::Instrumentor::Get().EndSession()
#define HG_PROFILE_SCOPE(name) ::hg::InstrumentationTimer time##__LINE__(name);
#define HG_PROFILE_FUNCTION() HG_PROFILE_SCOPE(__FUNCSIG__)
#else

...
namespace hg {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<KeyPressEvent>(HG_BIND_EVENT_FN(ImGuiLayer::OnKeyPressedEvent));
		...
		dispatcher.Dispatch<WindowResizedEvent>(HG_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
